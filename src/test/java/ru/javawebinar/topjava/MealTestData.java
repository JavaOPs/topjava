...
public class MealTestData {
    ...
    public static final UserMeal MEAL4 = new UserMeal(ID4, LocalDateTime.of(2011, 1, 1, 10, 0, 0), "Завтрак", 500);
    public static final UserMeal MEAL5 = new UserMeal(ID5, LocalDateTime.of(2011, 1, 1, 14, 0, 0), "Плотный обед", 1600);
    public static final UserMeal MEAL6 = new UserMeal(ID6, LocalDateTime.of(2015, 11, 25, 15, 0, 0), "Обед", 800);
    ...
    public static final List<UserMeal> BETWEEN_OF_ADMIN_ID = Arrays.asList(MEAL6, MEAL5, MEAL4);
    public static final List<UserMeal> ALL_OF_ADMIN_ID_AFTER_SAVE_MEAL7 = Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3,
            MEAL7_FOR_SAVE);
