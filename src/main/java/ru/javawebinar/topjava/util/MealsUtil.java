...
public class MealsUtil {
    ...
    private static List<Meal> mockMealsList = Arrays.asList(
    ...
    public static void main(String[] args) {
        ...
        List<MealTo> mealsTo = filteredByStreams(mockMealsList, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIES_PER_DAY);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<Meal> getMockMealsList() {
        return mockMealsList;
    }
}
