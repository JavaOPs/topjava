...
### **Получить первое открытое занятие МНОГОПОТОЧНОСТЬ и пройти эту важную тему в [проекте Masterjava](http://javaops.ru/view/masterjava)**
   ...
   - **До 18.09 на курс MasterJava для выпускников специальная цена** 
...
### **[Полное ревью выпускного проекта](https://javaops.ru/auth/payonline?payId=OG)**
   ...
   В нее входит проверка кураторами, ваши правки и затем моя финальная проверка.
...
### **Моя реализация выпускного проекта [TopJava-2](http://javaops.ru/view/topjava2)**
   ...
   - Есть несколько выгодных пакетов TopJava-2 + ревью выпускного проекта + курс MasterJava
   - **До 18.09 курс TopJava2 и все пакеты по минимальной цене** 
