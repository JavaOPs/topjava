...
- Поправил JavaScript: [переменные: let и const](https://learn.javascript.ru/let-const) и [Array in JSP Expression Language (EL)](https://www.tutorialspoint.com/jsp/jsp_expression_language.htm#:~:text=array)
