...
-  После завершения проекта вы освоите все заявленные в нем технологии - вставьте их в квалификацию (включая java 8 Stream and Time API). 
- В разделе опыт работы (если нет коммерческого опыта) вставьте:
...
- Делайте упор не на обучение, а на **участие в проекте**. Выполнение домашних заданий это полноценное участие с написанием функционала по всем пройденным технологиям. На собеседовании смотрят не на то, что вы заканчивали, а на опыт и знания.
- Обязательно уберите из резюме **любое упоминание Junior**. Количество обращений к вам возрастет на порядок. Ссылку на стажировку можно поставить: http://javaops.ru (в linkedin: https://www.linkedin.com/company/java-online-projects).

- Если рассмотриваете предложения по работе, поднимите в своем профиле этот флаг и обязательно заполните ссылку на резюме. Обновления нашей базы выпускников смотрят уже более 125 партнеров по трудоустройству (компании и индивидуальные рекрутеры). Также проверьте содержание "Информация для HR": по нему будут принимать решение, открывать резюме или нет.
