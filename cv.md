...
Если рассмотриваете предложения по работе, **поднимите в своем профиле этот флаг и обязательно заполните ссылку на резюме: я запустил интеграцию с HR (более 100 контактов). Также проверьте содержание "Обо мне": по нему будут принимать решение открывать резюме или нет.**
