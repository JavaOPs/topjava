...
- Объявляйте переменные непосредственно перед использованием (если возможно - сразу с инициализацией)
- Пользуйтесь форматированием кода в IDEA: `Alt+Ctrl+L`
- Не оставляйте в коде ничего лишнего: закомментированный код, TODO и пр.
