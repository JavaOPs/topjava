...
Для диапазона нужно использовать уже готовый `TimeUtil.isBetween`. Как приложение должно себя вести помно проверить <a href="http://topjava.herokuapp.com/">на demo</a>.
